 ...
 * @return Promise
 */
Database.prototype.remove = function remove(index) {
  var u = this.data.findIndex(u => u[this.index] == index)
 ...
 * @return Promise
 */
Database.prototype.delete = function del(index) {
