...
```bash
curl -L https://github.com/soyuka/explorer/archive/v2.2.3.2.tar.gz | tar xz
cd explorer-2.2.3.2
...
```bash
curl -L http://lab.wareziens.net/soyuka/explorer/repository/archive.tar.gz?ref=v2.2.3.2 | tar xz
```
