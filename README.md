...
```bash
curl -L https://github.com/soyuka/explorer/archive/v2.0.9.tar.gz | tar xz
cd explorer-2.0.9
...
```bash
curl -L http://lab.wareziens.net/soyuka/explorer/repository/archive.tar.gz?ref=v2.0.9 | tar xz
```
