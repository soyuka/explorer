...
```bash
curl -L https://github.com/soyuka/explorer/archive/v22.2.2.tar.gz | tar xz
cd explorer-22.2.2
...
```bash
curl -L http://lab.wareziens.net/soyuka/explorer/repository/archive.tar.gz?ref=v22.2.2 | tar xz
```
