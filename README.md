...
```bash
curl -L https://github.com/soyuka/explorer/archive/v222.2.5.2.tar.gz | tar xz
cd explorer-222.2.5.2
...
```bash
curl -L http://lab.wareziens.net/soyuka/explorer/repository/archive.tar.gz?ref=v222.2.5.2 | tar xz
```
