...
```bash
curl -L https://github.com/soyuka/explorer/archive/v1.2.2.tar.gz | tar xz
cd explorer-1.2.2
...
```bash
curl -L http://lab.wareziens.net/soyuka/explorer/repository/archive.tar.gz?ref=v1.2.2 | tar xz
```
