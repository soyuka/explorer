...
```bash
curl -L https://github.com/soyuka/explorer/archive/v1.0.15.tar.gz | tar xz
cd explorer-1.0.15
...
```bash
curl -L http://lab.wareziens.net/soyuka/explorer/repository/archive.tar.gz?ref=v1.0.15 | tar xz
```
